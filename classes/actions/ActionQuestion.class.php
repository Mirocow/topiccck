...
---------------------------------------------------------
*/
class PluginTopiccck_ActionQuestion extends PlugunTopiccck_Inherit_ActionQuestion {
	...
	public function Init() {
		...
		$this->oType=$this->PluginTopiccck_Topiccck_GetTopicTypeByTypeUrl('question');
	...
	protected function EventAdd() {
		...
		if($this->Viewer_GetSmartyObject()->getTemplateVars('aTopicTypes')){
			if(!in_array('question', $this->Viewer_GetSmartyObject()->getTemplateVars('aTopicTypes'))){
