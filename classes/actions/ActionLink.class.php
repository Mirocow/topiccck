...
---------------------------------------------------------
*/
class PluginTopiccck_ActionLink extends PlugunTopiccck_Inherit_ActionLink {
	...
	public function Init() {
		...
		$this->oType=$this->PluginTopiccck_Topiccck_GetTopicTypeByTypeUrl('link');
	...
	protected function EventAdd() {
		...
		if($this->Viewer_GetSmartyObject()->getTemplateVars('aTopicTypes')){
			if(!in_array('link', $this->Viewer_GetSmartyObject()->getTemplateVars('aTopicTypes'))){
