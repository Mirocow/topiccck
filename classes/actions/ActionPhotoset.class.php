...
---------------------------------------------------------
*/
class PluginTopiccck_ActionPhotoset extends PlugunTopiccck_Inherit_ActionPhotoset {
	...
	public function Init() {
		...
		$this->oType=$this->PluginTopiccck_Topiccck_GetTopicTypeByTypeUrl('photoset');
	...
	protected function EventAdd() {
		...
		if($this->Viewer_GetSmartyObject()->getTemplateVars('aTopicTypes')){
			if(!in_array('photoset', $this->Viewer_GetSmartyObject()->getTemplateVars('aTopicTypes'))){
